...
const App: FC = () => {
  ...
  const getUsdtBalance = async (addr: string): Promise<void> => {
    if (!addr) return;
  ...
  return (
    <div className="App">
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <button type="submit">Check USDT Balance</button>
      </form>
